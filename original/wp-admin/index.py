...
if is_user_admin():
  add_screen_option("layout_columns", {"max":4, "default":1})
else:
...
screen.add_help_tab({"id":"overview", "title":__("Overview"), "content":help})
help = "<p>"+__("The left-hand navigation menu provides links to all of the WordPress administration screens, with submenu items displayed on hover. You can minimize this menu to a narrow icon strip by clicking on the Collapse Menu arrow at the bottom.")+"</p>"
help+="<p>"+__("Links in the Toolbar at the top of the screen connect your dashboard and the front end of your site, and provide access to your profile and helpful WordPress information.")+"</p>"
screen.add_help_tab({"id":"help-navigation", "title":__("Navigation"), "content":help})
...
screen.add_help_tab({"id":"help-layout", "title":__("Layout"), "content":help})
...
if current_user_can(cap.create_posts):
...
screen.add_help_tab({"id":"help-content", "title":__("Content"), "content":help})
unset(help)
screen.set_help_sidebar("<p><strong>"+__("For more information:")+"</strong></p>"+"<p>"+__("<a href="http://codex.wordpress.org/Dashboard_Screen" target="_blank">Documentation on Dashboard</a>")+"</p>"+"<p>"+__("<a href="http://wordpress.org/support/" target="_blank">Support Forums</a>")+"</p>")
...
if has_action("welcome_panel")&&current_user_can("edit_theme_options"):
  ...
  hide = 0==option||2==option&&user_email!=get_option("admin_email")
  if hide:
    classes+=" hidden"
  ...
  print("		<a class="welcome-panel-close" href="")
  print(esc_url(admin_url("?welcome=0")))
  print("">")
  _e("Dismiss")
  print("</a>\n		")
